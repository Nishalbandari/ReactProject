...
const Footer = () => (
  <footer className="bg-blue-100">
    <div className="s pb-6 pt-16 sm:px-6 lg:px-12">
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-4">
        <div>
          ...
          <p className="mt-6 max-w-md text-center leading-relaxed text-zinc-950 sm:max-w-xs sm:text-left">
            Skillety Is A Revolutionary AI-Driven Job Portal Exclusively For The
            IT Industry. Our AI-Recruiter “Lety” Sources, Screens & Interviews
            Candidates Effectively With Over 96% Accuracy.
          </p>
        ...
        <div>
          <div className="text-center sm:text-left flex gap-8">
        ...
        <div>
          ...
          <div>
            ...
            <div className="flex gap-8">
              <img className="h-11 w-auto" src={google} alt="" />
              <img className="h-11 w-auto" src={appstore} alt="" />
            </div>
          </div>
        </div>
      </div>
    ...
    <div className="mt-12 border-t border-gray-100 pt-6 p-6">
      <div className="text-center sm:flex sm:justify-between sm:text-left">
        <p className="mt-4 text-sm text-gray-500 sm:order-first sm:mt-0">
          All trademarks are the property of their respective owners. All rights
          reserved © 2024 Skillety Technologies Private Ltd.
        </p>
      </div>
